///@param base_width
///@param base_height
function scr_resolution_adapt(base_width, base_height){
	...
	if (xscl < yscl) {
		...
		global.view_scale = global.view_yscale;
	} else {
		global.view_xscale = yscl / xscl;
		global.view_yscale = 1;
		global.view_scale = global.view_xscale;
	}
...
//Chame essa função em uma nova room
